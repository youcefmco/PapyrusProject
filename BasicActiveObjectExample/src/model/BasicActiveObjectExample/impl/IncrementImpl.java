 ...
 * </p>
 * <ul>
 *   <li>{@link model.BasicActiveObjectExample.impl.IncrementImpl#getCounter <em>Counter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IncrementImpl extends MinimalEObjectImpl.Container implements Increment {
	...
	protected EClass eStaticClass() {
		return BasicActiveObjectExamplePackage.Literals.INCREMENT;
	}
	...
	public void setCounter(int newCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicActiveObjectExamplePackage.INCREMENT__COUNTER, oldCounter, counter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasicActiveObjectExamplePackage.INCREMENT__COUNTER:
				return getCounter();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BasicActiveObjectExamplePackage.INCREMENT___INCREMENT:
				increment();
				return null;
		}
