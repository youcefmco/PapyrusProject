...
public class UtilAdapterFactory extends AdapterFactoryImpl {
	...
	protected UtilSwitch<Adapter> modelSwitch =
		new UtilSwitch<Adapter>() {
			...
			@Override
			public <E> Adapter caseCollection(Collection<E> object) {
				return createCollectionAdapter();
			}
			@Override
			public <E> Adapter caseSet(Set<E> object) {
				return createSetAdapter();
			}
			@Override
			public <E> Adapter caseQueue(Queue<E> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.ArrayList <em>Array List</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Queue <em>Queue</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
